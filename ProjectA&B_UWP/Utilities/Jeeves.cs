...
namespace ProjectA_B_UWP.Utilities
{
    public static class Jeeves
    {
        //For Local API
        //public static Uri DBUri = new Uri("https://localhost:7127/");

        //For Class Example on Azure
        public static Uri DBUri = new Uri("https://projectab2024.azurewebsites.net/");
